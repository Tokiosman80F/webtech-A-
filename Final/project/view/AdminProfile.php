<?php
	...
	$patients=admindata($_SESSION['aid']);
	$users=adminuser($_SESSION['aid']);

	//data retrieve fron users table
	foreach ($users as $user) {
		$password=$user["password"];
	}
	//data retrieve fron Admin table
...
<html>
	...
	<button type="button"name="home"class="button"onclick="window.location='AdminHomePage.php'">Home Page</button>
